...
async function deployPolygonGovernance(_network, _pk, _nodeURL, tellorAdd, disputeFee, teamMultisigAdd) {
    ...
    if (net == "mainnet"){
        ...
        console.log("Governance contract deployed to:","https://explorer.pops.one/address/"+ governance.address)
        console.log("    transaction hash:", "https://explorer.pops.one/txt/" + governance.deployTransaction.hash);
    } else if (net == "harmony_mainnet"){
        console.log("Governance contract deployed to:","https://explorer.harmony.one/address/"+ governance.address)
        console.log("    transaction hash:", "https://explorer.harmony.one/txt/" + governance.deployTransaction.hash);
